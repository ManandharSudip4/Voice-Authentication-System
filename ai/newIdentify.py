...
def identify(audioFile, threshold = -50):
    ...
    return predicted_speaker, score_of_individual_comparision, speakers
...
if __name__ == "__main__":
    speaker = sys.argv[1]
    predicted_speaker, scores, speakers = identify(audioFile + speaker)
    print('------------------------------------')
    for i, person in enumerate(speakers):
        print(f'{person}: {scores[i]}')
    print('------------------------------------')
